! function(a) {
    "use strict";
    var b = function() {
        this.$openBtn = a("#sidebar, #header").find("a[href*='#about']"), this.$closeBtn = a("#about-btn-close"), this.$blog = a("#blog"), this.$about = a("#about"), this.$aboutCard = a("#about-card")
    };
    b.prototype = {
        run: function() {
            var a = this;
...
function(a) {
    "use strict";
    var b = function() {
        this.$shareOptionsBar = a("#share-options-bar"), this.$openBtn = a(".btn-open-shareoptions"), this.$closeBtn = a("#btn-close-shareoptions"), this.$body = a("body")
    };
    b.prototype = {
        run: function() {
            var a = this;
        ...
        openShareOptions: function() {
            var a = this;
            a.$shareOptionsBar.hasClass("opened") || this.$shareOptionsBar.hasClass("processing") || (a.$shareOptionsBar.addClass("processing opened"), a.$body.css("overflow", "hidden"), setTimeout(function() {
        ...
        closeShareOptions: function() {
            ...
            a.$shareOptionsBar.hasClass("opened") && !this.$shareOptionsBar.hasClass("processing") && (a.$shareOptionsBar.addClass("processing").removeClass("opened"), setTimeout(function() {
                a.$shareOptionsBar.removeClass("processing"), a.$body.css("overflow", "")
            }, 250))
        }
    }, a(document).ready(function() {
        (new b).run()
